...
export default function RoomDashboard({ onJoinRoom, onLogout, currentUser, onUpdateUser }) {
    ...
    const handleSaveProfile = async (e) => {
        ...
        if (trimmedName !== '' && (trimmedName.length < 2 || trimmedName.length > 30)) {
            setNotification({ type: 'error', message: "Display name must be between 2 and 30 characters." });
            return;
        }
    ...
    return (
        <div className="devroom-dashboard" style={{ width: '100%', maxWidth: '1080px', margin: '0 auto', padding: '30px 20px', boxSizing: 'border-box' }}>
            ...
            <div className="devroom-navbar" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <button 
                        ...
                        className="navbar-profile-btn logout-3d-btn"
                    ...
                    >
                        ...
                        <span style={{ fontSize: '13.5px', color: '#fff', fontWeight: '500', marginRight: '6px' }}>
                            {currentUser.displayName ? currentUser.displayName : `${currentUser.firstName} ${currentUser.lastName || ''}`}
                        </span>
                    </button>
                    <button onClick={onLogout} className="navbar-logout-btn logout-3d-btn">
                        <span className="logout-btn-glow"></span>
                        Log out
                    </button>
                </div>
            ...
            {/* Sub-Header Area */}
            <div className="devroom-intro" style={{ textAlign: 'center', marginBottom: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div className="devrooms-title-container devroom-card" style={{ marginBottom: '16px' }}>
                    <div className="devroom-card-info" style={{ padding: '8px 36px', textAlign: 'center' }}>
                        <h1 className="devrooms-title-text">DEVROOMS</h1>
                    </div>
                </div>
            ...
            <div className="dashboard-grid-layout" style={{ display: 'grid', gridTemplateColumns: '1.1fr 1.9fr', gap: '28px', alignItems: 'start' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <div className="devroom-card">
                        <div className="devroom-card-info" style={{ padding: '28px', textAlign: 'left' }}>
                            <h4 style={{ margin: '0 0 16px 0', fontSize: '20px', fontWeight: '800', background: 'linear-gradient(135deg, #7c3aed 0%, #000000 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', letterSpacing: '1.5px', textTransform: 'uppercase' }}>
                                CREATE
                            </h4>
                ...
                <div className="devroom-card">
                    <div className="devroom-card-info" style={{
                        padding: '28px',
                        minHeight: '410px',
                        display: 'flex',
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                            <h4 style={{ margin: 0, fontSize: '20px', fontWeight: '800', background: 'linear-gradient(135deg, #7c3aed 0%, #000000 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', letterSpacing: '1.5px', textTransform: 'uppercase' }}>
                                SESSIONS
                            </h4>
                                        ...
                                        <div key={room.roomId} className="room-item-row" style={{
                                            ...
                                            <div style={{ textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '6px' }}>
                                                ...
                                                <div style={{ fontSize: '12.5px', color: '#9ca3af', display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap' }}>
                                                    ...
                                                    <span>{room.hostId ? (room.hostId.displayName || room.hostId.firstName) : 'Unknown'}</span>
            ...
            {customizingProfile && (
                <div className="customization-modal-overlay">
                    <div className="customization-modal-content devroom-card" style={{ padding: 0 }}>
                        <div className="devroom-card-info" style={{ padding: '28px', textAlign: 'left' }}>
                            <h4 style={{ margin: '0 0 16px 0', fontSize: '20px', fontWeight: '800', background: 'linear-gradient(135deg, #7c3aed 0%, #000000 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', letterSpacing: '1.5px', textTransform: 'uppercase' }}>
                                CUSTOMIZE PROFILE
                            </h4>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
                            ...
                            >
                                ...
                                >
                                    {getInitials({ displayName: profileDisplayName, firstName: currentUser.firstName, lastName: currentUser.lastName })}
                                </Avatar>
                            </div>
                            
                            <span style={{ fontSize: '13px', color: '#9ca3af', textAlign: 'center' }}>
                                Click the avatar icon to change photo
                            </span>
                        </div>
 
                        <form onSubmit={handleSaveProfile} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <div className="form-group" style={{ gap: '8px' }}>
                                <label className="form-label" style={{ fontSize: '13px', color: '#9ca3af', fontWeight: '500' }}>Display Name</label>
                                <input 
                                    type="text" 
                                    className="form-input" 
                                    style={{
